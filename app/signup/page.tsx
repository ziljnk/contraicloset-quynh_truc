...
export default function SignUpPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			// Optional: Add display name or other data here if needed
				...
				<div className="space-y-3">
					...
					>
						<svg
							...
							viewBox="0 0 24 24"
						>
							<path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v2.225l-.338.006c-2.469.044-2.939 1.171-2.939 2.58v2.45h3.189l-1.094 3.667h-2.095v8.004a12.057 12.057 0 0 0 3.402-.451C20.737 22.016 24 17.516 24 12c0-6.627-5.373-12-12-12S0 5.373 0 12c0 5.628 3.487 10.368 8.468 12.186a12.062 12.062 0 0 0 .633.205zM12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12z" />
						</svg>
